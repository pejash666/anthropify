...
// ErrUnsupported is the canonical sentinel returned by an adapter's
// Invoke implementation when it has no native non-streaming endpoint.
// The top-level Client uses errors.Is against this value to decide
